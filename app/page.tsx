...
import { Scissors, Clock, Shield, ArrowRight, CalendarCheck, Users } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="flex flex-col items-center text-center gap-8 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-4">
            <Button asChild size="lg" className="bg-gold text-black hover:bg-gold/90 px-8">
              <Link href="/barbeiro/login">
                Acesso Barbeiros
                <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="border-gold/30 hover:bg-gold/10 px-8">
              <Link href="/b/ventus">
                Ver Demo Cliente
              </Link>
            </Button>
